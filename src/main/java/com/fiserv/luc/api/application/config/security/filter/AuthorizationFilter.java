...
//            final String jsonString = decode(token);
//
//            final Test test = objectMapper.readValue(jsonString, Test.class);
//
...
//     * @return String
//     */
//    public static String extractToken(final ServletRequest request) {
//
...
//    @NoArgsConstructor
//    @AllArgsConstructor
//    public static class Test implements UserDetails, Serializable {
...
//
//        public Test(final String email) {
//            this.email = email;
//        }
//
//        /**
